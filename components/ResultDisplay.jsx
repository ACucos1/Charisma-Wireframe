    ...
    <div className={styles.resultDisplayWrapper}>
        ...
        <div className={styles.resultDisplay}>
            <ul className={styles.traitsList}>
              <li className={`${styles.trait} ${styles.trait1}`}>{wpi && wpi["1"].info.LongDesc}</li>
              <li className={`${styles.trait} ${styles.trait2}`}>{wpi && wpi["2"].info.LongDesc}</li>
              <li className={`${styles.trait} ${styles.trait3}`}>{wpi && wpi["3"].info.LongDesc}</li>
              <li className={`${styles.trait} ${styles.trait4}`}>{wpi && wpi["4"].info.LongDesc}</li>
            </ul>
